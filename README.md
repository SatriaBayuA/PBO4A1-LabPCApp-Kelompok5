...
Tahap 1, install semua software
Tahap 2, setup database MySQL
Tahap 3, buka project di NetBeans
Tahap 4, konfigurasi koneksi database
Tahap 5, setup Tomcat di NetBeans
Tahap 6, set server untuk project
Tahap 7, build dan run project
Struktur package
Fitur aplikasi
Daftar validasi
Troubleshooting
...
Cari dan pilih file labpc_db.sql yang ada di folder database, di dalam folder project ini hasil ekstrak zip
...
Pastikan database labpc_db sudah muncul dengan 3 tabel yaitu pc, peminjam, dan transaksi
...
private static final String URL = jdbc:mysql://localhost:3306/labpc_db?useSSL=false&serverTimezone=Asia/Jakarta
...
Folder database, berisi file labpc_db.sql yaitu script SQL untuk membuat database.
